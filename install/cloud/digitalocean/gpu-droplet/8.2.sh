...
EIGHTBALL_PROVIDER_ASSUMPTION="data/generated/provider-assumptions/cloud-digitalocean-gpu-droplet.json"

EIGHTBALL_INSTALL_PROFILE="cloud/digitalocean/gpu-droplet"
